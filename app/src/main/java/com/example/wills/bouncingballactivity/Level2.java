...
public class Level2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0;i<badies;i++)
            bads[i] = (ImageView)((RelativeLayout) findViewById(R.id.badies2)).getChildAt(i);
        for(int i=0;i<goodies;i++)
            goods[i] = (ImageView)((RelativeLayout) findViewById(R.id.goodies2)).getChildAt(i);
        for(int i=0;i<goal;i++)
            food[i] = (ImageView)((RelativeLayout) findViewById(R.id.foods2)).getChildAt(i);
    ...
    protected static void tick(Rect R1)
    {
        ...
        for(int i = 0; i<badies; i++){
            ...
            if(R1.intersect(R2)) {
                CustomDrawableView2.kill2=true;
    ...
    public void rePlay(View view){
        Intent replay = new Intent(this, Level2.class);
